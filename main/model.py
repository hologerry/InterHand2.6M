...
from common.nets.loss import HandTypeLoss, JointHeatmapLoss, RelRootDepthLoss
...
class Model(nn.Module):
    ...
    def forward(self, inputs, targets, meta_info, mode):
        ...
        if mode == "train":
            ...
            joint_z = torch.gather(idx_z, 2, joint_y[:, :, :, None].repeat(1, 1, 1, cfg.output_hm_shape[1]))[
                :, :, 0, :
            ]
